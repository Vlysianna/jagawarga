...
export default function KecReportDetailPage({
  params,
}: {
  ...
  if (!report) {
    return (
      <div>
        <PageHeader title="Laporan Tidak Ditemukan" backHref="/kec/reports" />
  ...
  const canAct = report.currentLevel === "kec" && report.currentStatus === "pending";

  function handleSubmitAction() {
    setDone(true);
    setTimeout(() => router.push("/kec/reports"), 2000);
  }

  if (done) {
    const labels = { forward: "diteruskan ke Pemda", reject: "ditolak" };
    return (
      <div>
        <PageHeader title="Detail Laporan" backHref="/kec/reports" />
        <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-neutral-border p-5">
          ...
          <div className="flex items-center gap-2 flex-wrap mb-4">
            ...
            <span className="text-xs text-neutral-text">dari Kel. {report.kelurahan}</span>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-blue-light rounded-lg border border-blue-border">
                <p className="text-sm text-blue-dark">
                  Laporan akan diteruskan ke <strong>Pemerintah Daerah</strong> untuk keputusan final.
                </p>
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-neutral-dark">Catatan untuk Pemda</label>
                <textarea
                  rows={3}
              ...
              <div className="flex gap-3">
                <Button size="sm" onClick={handleSubmitAction} disabled={!note}>Kirim ke Pemda</Button>
