...
export default function RTNewReportPage() {
  ...
  if (submitted) {
    return (
      <div>
        <PageHeader title="Buat Laporan Resmi" backHref="/rt/reports" />
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="text-lg font-bold text-foreground mb-2">
            Laporan Terkirim ke RW
          </h2>
          <p className="text-sm text-neutral-text">
            Laporan resmi dengan estimasi anggaran sudah dikirim ke Ketua RW
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Buat laporan resmi dengan estimasi anggaran dan kirim ke RW"
        backHref="/rt/reports"
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="bg-white rounded-xl border border-neutral-border p-5 space-y-5">
          <Input
            label="Judul Laporan"
            placeholder="Contoh: Perbaikan Jalan Melati No. 15"
            value={title}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              id="note"
              rows={3}
              placeholder="Tuliskan catatan atau alasan pengajuan ke RW..."
              value={note}
        ...
        <div className="bg-blue-light rounded-xl p-4 border border-blue-border">
          <p className="text-sm text-blue-dark">
            ...
            Ketua RW beserta estimasi anggaran. RW dapat menyetujui, menolak,
            atau meneruskan ke Kelurahan.
          </p>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <Button
            type="button"
            variant="ghost"
            onClick={() => router.push("/rt/reports")}
          >
            Batal
          </Button>
        </div>
